...
typedef struct cfont{
    char content[128];  //字体内容
    unsigned int size;  //字体大小
    unsigned int pos_x; //字体板x坐标
    unsigned int pos_y; //字体板y坐标
    unsigned int fcolor; //字体颜色
    unsigned int bgw;   //背景宽度
    unsigned int bgh;   //背景高度
    unsigned int bgcolor;//背景颜色 0xAE86FC
    unsigned int linew; //每行宽度
}font_t;
